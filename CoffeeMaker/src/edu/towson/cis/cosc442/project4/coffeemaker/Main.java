 ...
 */
public class Main {
    private static final String PLEASE_ENTER_THE_RECIPE_PRICE_$ = "%nPlease enter the recipe price: $";
	private static final String PLEASE_ENTER_THE_RECIPE_NAME = "%nPlease enter the recipe name: ";
	...
	public static void addRecipe() {
	    //Read in recipe name
	    final String name = inputOutput(PLEASE_ENTER_THE_RECIPE_NAME);
	    
	    //Read in recipe price
	    final String priceString = inputOutput(PLEASE_ENTER_THE_RECIPE_PRICE_$);
